...
export const SHOWCASE_THEMES: ShowcaseTheme[] = [
  ...
  { id: "miramar", name: "The Miramar", vibe: "Catholic · Coastal", tagline: "Where the sea keeps the vow.", art: "miramar", palette: ["#3c7ea6", "#d98c9a", "#c6a253"], demo: "miramar", category: "wedding" },
